...
public interface NetworkRelationshipDAO {
     ...
     */
    public boolean insertNetworkRelationship(NetworkRelationshipTransferObject theNode, 
    ...
    public Iterator<NetworkRelationshipTransferObject> 
        getNetworkRelationships(NetworkNodeTransferObject theNode);
     ...
     */
    public Iterator<NetworkRelationshipTransferObject> 
        getNetworkRelationships(NetworkNodeTransferObject theNode, String key);
