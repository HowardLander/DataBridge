...
public class NetworkListenerMessage implements AMQPMessageType {
  ...
  public static final String VIZ_TARGET_DIR = "viz_target_dir";
  public static final String VIZ_LIST_FILE = "viz_list_file";
  ...
  public static final String JSON_FILE_CREATED ="JSON.File.Created";
